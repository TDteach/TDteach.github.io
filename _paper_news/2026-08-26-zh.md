...
layout: paper-news
lang: "zh-CN"
title: "AI 论文日报（2026-08-26）"
date: 2026-08-26
permalink: /paper-news/2026-08-26-zh/
author_profile: false
brief_title: "运行时安全落地了。"
brief_dek: "8 月 26 日的论文把智能体安全做成可执行系统：一边补上运行时策略与信任治理，一边用更苛刻的基准去测试规划、约束保真和真实完成度。"
lead_paper:
  ...
  why: "它给出了最可复用的运行时抽象：把智能体风险写成数据流，再验证敏感信息究竟被允许流向哪里。"
  skepticism: "它的形式保证仍局限于策略可见、被建模出来的行为范围。"
  tags:
    - "agent-security"
    - "dataflow-policy"
    - "runtime-governance"
    - "verification"
takeaways:
  - "最重要的安全转向，是从提示词层面的谨慎，走向对数据流、策略调用和阶段化信任的运行时治理。"
  - "可执行基准正在真实考验权限、依赖、迁移完成度和长链规划，而不再只看最终答案文本。"
  - "当系统先显式保存中间状态，再决定动作时，可靠性会明显高于自由流式的 agent loop。"
themes:
  - title: "运行时治理"
    text: "策略、溯源和信任窗口正在直接进入动作执行循环。"
  - title: "可执行真实"
    text: "更好的基准开始按权限、资源和长链任务去考真正执行。"
  - title: "先保状态"
    text: "技能库、FSM 和类型化控制器正在稳定胜过自由式工具调用。"
signals:
  - label: "安全架构"
    title: "信任成了运行时问题。"
    text: "AgentFlow、TrustShiftProbe、RePolicy 和 Attnlocate 都把执法推到了活的执行层和提供方信任层。"
  - label: "基准转向"
    title: "过测试已经不够。"
    text: "MobilePA-Bench、PeakBench、NetConfArena 和 SWE Refactor Bench 开始检查权限、调度和真实变更是否完成。"
  - label: "可靠性模式"
    title: "显式状态正在获胜。"
    text: "TRACE、自动机预测、动态本体和 OODA 控制都在把状态保真和动作选择拆开。"
top_papers:
  - title: "AgentFlow: A Flow-Centric Policy Language and Framework for Securing LLM Agent Systems"
    url: "https://arxiv.org/abs/2608.22868v1"
    pdf: "https://arxiv.org/pdf/2608.22868v1.pdf"
    why: "最值得先读，因为它同时给出运行时策略语言和强烈的入侵/效用结果。"
    why_now: "智能体越来越常在工具、记忆和委托任务之间搬运敏感信息。"
    skepticism: "保证强度取决于运行时究竟能看到、并形式化多少结构。"
  - title: "MobilePA-Bench: Benchmarking Mobile Planner Agents on Complex Real-World Tasks"
    ...
    why: "它是很强的配套基准，直接暴露了智能体在顺序、权限和运行时约束下的脆弱性。"
    why_now: "移动副驾是消费级智能体最现实的近期落地面之一。"
    skepticism: "沙盒手机环境依旧简化了真实设备和用户历史的复杂性。"
  - title: "TrustShiftProbe: Characterizing, Benchmarking, and Defending Staged Trust Attacks on MCP Servers"
    ...
    why: "它定义了静态检查很难发现的延迟型工具信任失败。"
    why_now: "MCP 风格工具生态扩张速度，已经超过了大家审计其信任假设的速度。"
    skepticism: "基于传输边界的审计仍可能漏掉更深层的语义或串联攻击。"
  - title: "TRACE: A Self-Evolving Skill Bank for Consistent, Limit-Aware LLM Agents"
    ...
    why: "它直击一致性和知道自己边界这两个真正产品化需要的能力。"
    why_now: "真正进产品的智能体，需要稳定表现，而不是偶发高光。"
    skepticism: "目前收益主要出现在特定基准化助手领域。"
  - title: "SWE Refactor Bench: Can Coding Agents Complete a Long-Horizon, Whole-Repository Stack Migration?"
    ...
    why: "它抓住了“测试过了但迁移没做完”这一类最实际的编码智能体失败。"
    why_now: "编码智能体正在被推向更大、更危险的整仓库改造任务。"
    skepticism: "即便比旧基准真实很多，它的覆盖广度仍然有限。"
---
> 英文版：[/paper-news/2026-08-26/](/paper-news/2026-08-26/)
...
<div class="paper-news-stats" style="border:2px solid #3b82f6;background:#f0f7ff;border-radius:10px;padding:12px 14px;margin:14px 0 18px 0">
  ...
  <ul>
    <li><strong>候选论文</strong>: 370</li>
    <li><strong>首页摘要入选论文</strong>: 5</li>
    <li><strong>证据基础</strong>: 基于重建得到的候选论文标题与摘要</li>
    <li><strong>全文通读</strong>: 未执行</li>
    <li><strong>时间窗口 (UTC)</strong>: 2026-08-24T00:00:00Z → 2026-08-25T00:00:00Z</li>
  </ul>
</div>
