...
brief_dek: "Today’s strongest papers shift trust from benchmark scores and reasoning traces toward runtime controls, evidence-backed evaluation, and system-level security tests for real agents."
lead_paper:
  ...
  why: "It tests agent jailbreaks where physical side effects matter, exposing execution failures that text-only safety evaluation misses."
  skepticism: "Results are centered on OpenClaw and a 117-task seed set, so cross-platform generality is still unclear."
  tags:
    - "agent-safety"
    - "os-agents"
    - "jailbreaks"
...
signals:
  - label: "Signal"
    title: "Benchmarks need retained evidence."
    text: "LITMUS, evidence-supported score bounds, Acceptance Cards, and WildClawBench all push evaluation toward auditable artifacts and real side effects."
  - label: "Tension"
    title: "Reasoning can mislead alignment."
    text: "Pseudo-Deliberation shows value talk can diverge from actions, while runtime auditing and provenance methods target behavior instead."
  - label: "Bet"
    title: "Runtime control will beat retraining."
    text: "PRISM, Shepherd, AgentRunner, and black-box drift detection all invest in monitoring, intervention, and governance around deployed agents."
top_papers:
  - title: "LITMUS: Benchmarking Behavioral Jailbreaks of LLM Agents in Real OS Environments"
    url: "https://arxiv.org/abs/2605.10779v1"
    pdf: "https://arxiv.org/pdf/2605.10779v1.pdf"
    why: "Useful if you care about real agents: it measures whether refusals hold once models can actually act in an OS."
    why_now: "Desktop and tool-using agents are moving into workflows where physical execution matters more than chat safety."
    skepticism: "Platform scope is still narrow, and benchmark coverage may not capture the full diversity of deployed agent tasks."
  - title: "Can Agent Benchmarks Support Their Scores? Evidence-Supported Bounds for Interactive-Agent Evaluation"
    ...
    why: "It gives a practical way to turn shaky agent leaderboard scores into evidence-backed bounds researchers can trust more."
    why_now: "Agent benchmarks are increasingly used for model selection even when retained artifacts do not fully support claimed success."
    skepticism: "It provides partial-identification bounds from sampled audits, not full certification of benchmark outcomes."
  - title: "Pseudo-Deliberation in Language Models: When Reasoning Fails to Align Values and Actions"
    ...
    why_now: "Many alignment pipelines still treat deliberative traces as a safety signal despite weak evidence they predict behavior."
    skepticism: "The setup depends on automatic value extraction and advice scenarios, so transfer to broader deployments is uncertain."
  - title: "TRACER: Verifiable Generative Provenance for Multimodal Tool-Using Agents"
    url: "https://arxiv.org/abs/2605.09934v1"
    pdf: "https://arxiv.org/pdf/2605.09934v1.pdf"
    why: "It makes provenance a trainable, generation-time object, improving both auditability and local credit assignment for tool-using agents."
    why_now: "As multimodal agents spread, teams need finer-grained evidence than coarse trajectory logs to verify outputs."
    skepticism: "Claims rely partly on LLM-as-judge evaluation and a constrained tool environment."
  - title: "Beyond Red-Teaming: Formal Guarantees of LLM Guardrail Classifiers"
    ...
    why: "Formal guarantees for LLM guardrails; highly relevant to deployment safety and robustness."
