...
brief_dek: "Today’s strongest papers argue that reliable agents need external control layers, process-level evaluation, and multi-turn threat models because prompt-only alignment breaks under history, peers, and persistent state."
lead_paper:
  title: "Language-Based Agent Control"
  url: "https://arxiv.org/abs/2605.12863v1"
  pdf: "https://arxiv.org/pdf/2605.12863v1.pdf"
  why: "It offers a reusable control architecture: typed programs and runtime checks for agent actions, not just better refusals."
  skepticism: "Strict policies reduce utility, and the Haskell-centered implementation may slow adoption outside specialized stacks."
  tags:
    - "agent-safety"
    - "runtime-enforcement"
    - "access-control"
signals:
  - label: "Signal"
    ...
    text: "Language-Based Agent Control, provenance gates, externalized defense co-evolution, and semantic fuzzing all move control into runtimes, memory, and audit layers."
  - label: "Tension"
    title: "Interactive settings break aligned behavior."
    text: "History Anchors, LLM-Based Persuasion, multi-agent sycophancy, and hidden-intent moderation show single-turn safety can collapse under prior actions or peer influence."
  - label: "Bet"
    title: "Process metrics will replace pass rates."
    text: "AgentLens, CiteVQA, RealICU, and EVA-Bench all reward evidence, trajectory quality, hindsight judgment, or end-to-end reliability over answer-only success."
top_papers:
  - title: "Language-Based Agent Control"
    url: "https://arxiv.org/abs/2605.12863v1"
    pdf: "https://arxiv.org/pdf/2605.12863v1.pdf"
    why: "A concrete systems approach to agent safety that constrains execution with typed policies and runtime enforcement."
    why_now: "As tool-using agents gain memory and autonomy, prompt hardening alone is no longer a credible control strategy."
    skepticism: "Utility drops under stricter policies, and results may depend on a specialized runtime model."
  - title: "History Anchors: How Prior Behavior Steers LLM Decisions Toward Unsafe Actions"
    ...
    why: "It shows prior action history can strongly flip aligned models toward unsafe choices, which matters for any agent loop with memory."
    why_now: "Many deployed agents feed logs and prior actions back into the model without testing history-conditioned safety."
  ...
  - title: "AgentLens: Revealing The Lucky Pass Problem in SWE-Agent Evaluation"
    ...
    why_now: "SWE-agent rankings and training pipelines still rely heavily on pass/fail outcomes."
    skepticism: "Current evidence is scoped to OpenHands traces and tasks with multiple passing trajectories."
  - title: "Negation Neglect: When models fail to learn negations in training"
    ...
    why: "A sharp warning that common safety-data patterns can backfire by teaching the forbidden claim instead of the negation."
    why_now: "Synthetic post-training corpora often use disclaimers, warnings, and 'false' wrappers at scale."
    skepticism: "The evidence comes from synthetic finetuning settings, so transfer to broader training pipelines is not fully settled."
